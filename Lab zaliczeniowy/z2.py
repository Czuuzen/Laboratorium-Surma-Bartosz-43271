...
print("Koszt ubezpieczenia emerytalnego", format(emerytalne(num1), '.2f')," PLN")
...
print("Płaca pracownika wynosi: ", format((num1), '.2f')," PLN, opłaty na pracownika to: ", format(lacznie(), '.2f')," PLN,")
